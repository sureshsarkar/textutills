    ...
    return (
        ...
        <div className="wrapper mx-3">
            ...
            <div className="text-input d-flex">
                <textarea name="from" className="textareacls from-text mx-2" placeholder="Enter Text" id="from" value={fromText} onChange={(e) => setFromText(e.target.value)}></textarea>
                <textarea name="to" className="textareacls to-text mx-2" id="to" value={toText} readonly></textarea>
            </div>
        </div>
